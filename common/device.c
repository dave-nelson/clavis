...
const uint8_t PROGMEM endpoint_config_table[ENDPOINT_CONFIG_SIZE] = {
    ...
    // Endpoint 2
    1, EP_TYPE_INTERRUPT_IN, EP_SIZE(NKRO_KEYBOARD_SIZE) | NKRO_KEYBOARD_BUFFER,
    // Endpoint 3
    0,
    // Endpoint 4
    0
...
static uint8_t PROGMEM nkro_keyboard_hid_report_desc[] = {
    ...
    0x91, 0x03,         /*      Output (Constant, Variable),            */
                        ...
                        /*          Keyboard (in) -- 29 bytes total     */ 
                        /*          Padding: "Reserved (no event)"      */
    0x75, 0x01,         /*      Report Size (1),                        */
    0x95, 0x01,         /*      Report Count (1),                       */
    ...
    0x05, 0x07,         /*      Usage Page (Keyboard),                  */
    0x19, 0x01,         /*      Usage Minimum (KB ErrorRollOver),       */
    0x29, 0xA4,         /*      Usage Maximum (KB ExSel),               */
    0x15, 0x00,         /*      Logical Minimum (0),                    */
    0x25, 0x01,         /*      Logical Maximum (1),                    */
    0x81, 0x02,         /*      Input (Variable),                       */

                        /*          Padding: "Reserved A5-AF"           */
    0x75, 0x01,         /*      Report Size (1),                        */
    ...
    0x05, 0x07,         /*      Usage Page (Keyboard),                  */
    0x19, 0xB0,         /*      Usage Minimum (Keypad 00),              */
    0x29, 0xDD,         /*      Usage Maximum (Keypad hexadecimal),     */
    0x15, 0x00,         /*      Logical Minimum (0),                    */
    0x25, 0x01,         /*      Logical Maximum (1),                    */
    0x81, 0x02,         /*      Input (Variable),                       */

                        /*          Padding: "Reserved DE-DF"           */
    0x75, 0x01,         /*      Report Size (1),                        */
...
#define KEYBOARD_CONFIG_SIZE            (9 + 9 + 7)
#define NKRO_KEYBOARD_CONFIG_SIZE       (9 + 9 + 7)
...
static uint8_t PROGMEM config1_descriptor[CONFIG1_DESC_SIZE] = {
	...
	1,					// bNumDescriptors
	0x22,					// bDescriptorType
	sizeof(nkro_keyboard_hid_report_desc),	// wDescriptorLength
	0,
	// endpoint descriptor, USB spec 9.6.6, page 269-271, Table 9-13
	7,					// bLength
	5,					// bDescriptorType
...
struct descriptor_list_struct PROGMEM descriptor_list[NUM_DESC_LIST] = {
	...
	{0x2200, NKRO_KEYBOARD_INTERFACE, nkro_keyboard_hid_report_desc, sizeof(nkro_keyboard_hid_report_desc)},
	{0x2100, NKRO_KEYBOARD_INTERFACE, config1_descriptor+NKRO_KEYBOARD_HID_DESC_OFFSET, 9},
